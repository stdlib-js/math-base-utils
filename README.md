...
```javascript
utils = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-utils@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-utils/tags). For example,

```javascript
utils = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-utils@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-utils@umd/browser.js"></script>
```
